...
const Nav = () => {
    ...
    const content = <aside className="absolute top-0 left-0 w-full pb-[130px] backdrop-blur-lg flex justify-center lg:hidden md:hidden">
            ...
            <ul className="flex flex-col mt-[80px]">
                ...
                <Link spy={true} smooth={true} to="Secao1">
                    <li className="menu-links hover:bg-[#F7EDB2] hover:text-[#FFAC33]">What's Included</li>
                </Link>
    ...
    return (
        <nav className="flex colorText3 relative z-10">
            <div className="flex py-[40px] px-[40px] fixed top-0 left-0 right-0">
                ...
                <div className="lg:flex text-[18px] colorText3 hidden">
                    <div className="flex-10">
                        <ul className="flex items-center gap-10 mr-16 text-[18px] font-bold">
                            <Link spy={true} smooth={true} to="About">
                                <li className="colorText3 hover:text-[#FFAC33] cursor-pointer">About</li>
                            </Link>
                            <Link spy={true} smooth={true} to="IncludedIn">
                                <li className="colorText3 hover:text-[#FFAC33] cursor-pointer">What's Included</li>
                            </Link>
                            <Link spy={true} smooth={true} to="Secao2">
                                <li className="colorText3 hover:text-[#FFAC33] cursor-pointer">Seção 2</li>
                            </Link>
                            <Link spy={true} smooth={true} to="Footer">
                                <li className="colorText3 hover:text-[#FFAC33] cursor-pointer">Footer</li>
                            </Link>
                            <div>
