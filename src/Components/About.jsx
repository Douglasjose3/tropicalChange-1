...
const About = () => {
    ...
    return (
        <div id="About" className="flex justify-center items-center mt-[130px]">
            <div className="lg:w-[480px] items-center justify-center bg-white bg-opacity-60 p-8 rounded-xl hover:sm w-[90%]">
